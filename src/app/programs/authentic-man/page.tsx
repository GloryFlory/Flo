      ...
      <section className="bg-gradient-to-br from-accent/10 to-accent/20 py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl font-heading font-bold mb-4 text-ink">
            Becoming the Authentic Man — UPDATED
          </h1>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            ...
            <div className="bg-white rounded-xl shadow-lg border-2 border-accent/20 p-8 text-center">
              ...
              <p className="text-sm text-ink/60 mb-6 italic">Perfect for men curious about deeper self-work</p>
              
              <a
                href="https://calendly.com/florian-hohenleitner/how-can-i-help"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-accent text-white px-6 py-3 rounded-lg font-medium hover:bg-accent/90 transition-colors duration-200 w-full"
              >
                Book Session
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-xl border-2 border-accent p-8 text-center relative">
              ...
              <div className="mb-8">
                ...
                <div className="text-3xl font-bold text-accent mb-4">€650-€750</div>
              ...
              <p className="text-sm text-ink/60 mb-6 italic">For men ready to break free from expectations</p>
            ...
            <div className="bg-white rounded-xl shadow-lg border-2 border-accent/20 p-8 text-center">
              ...
              <div className="mb-8">
                ...
                <div className="text-3xl font-bold text-accent mb-4">€1,800-€2,000</div>
